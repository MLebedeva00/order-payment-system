...
## Цель проекта
Демонстрация применения слоистой архитектуры, принципа инверсии зависимостей (DIP) и элементов Domain-Driven Design (DDD) в реализации системы оплаты заказа.
